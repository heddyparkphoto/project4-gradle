...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public FetchJokes fetchJokes(java.lang.String flavor) throws java.io.IOException {
    FetchJokes result = new FetchJokes(flavor);
    initialize(result);
    return result;
  }
  ...
  public class FetchJokes extends MyApiRequest<com.learn.heddy.biggerbetter.backend.myApi.model.MyBean> {
    ...
    private static final String REST_PATH = "fetchJokes/{flavor}";
     ...
     * @since 1.13
     */
    protected FetchJokes(java.lang.String flavor) {
    ...
    public FetchJokes setFlavor(java.lang.String flavor) {
      this.flavor = flavor;
      return this;
    }
