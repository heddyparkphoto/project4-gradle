...
package com.learn.heddy.biggerbetter.backend.myApi.model;
...
public final class MyBean extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<java.lang.String> myListData;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<java.lang.String> getMyListData() {
    return myListData;
  }

  /**
   * @param myListData myListData or {@code null} for none
   */
  public MyBean setMyListData(java.util.List<java.lang.String> myListData) {
